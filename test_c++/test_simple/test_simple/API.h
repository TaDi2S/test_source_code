...
public:
	...
	CString MakeKc(long Init);
	CString MakeRn(long Init);
	CString EncryptKc(CString inKc);
	void DecryptKc(CString inHexKc, char *reKc);
	CString DecryptKc(CString inHexKc);
	CString EncryptKc(char *inKc);

	CString DecryptIdRn(CString inHexId);
	CString EncryptIdRn(CString inID);
	...
	void SetKeyCString(CString key);
